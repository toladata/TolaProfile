...
from userprofile.models import TolaUser
...
class Task(models.Model):
    ...
    created_by = models.ForeignKey(TolaUser,blank=True,null=True,verbose_name=_('Created By'), related_name='task_created_by')
    ...
    assigned_to = models.ForeignKey(TolaUser,blank=True,null=True,verbose_name=_('Assigned to'),related_name='task_assigned_to')
